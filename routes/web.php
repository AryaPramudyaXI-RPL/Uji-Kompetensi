...
use App\Http\Livewire\Admin\AdminAddAtributeComponent;
...
use App\Http\Livewire\Admin\AdminEditAtributeComponent;
...
Route::middleware(['auth:sanctum','verified','authadmin'])->group(function(){
    ...
    Route::get('/admin/attribute/add',AdminAddAtributeComponent::class)->name('admin.addattribute');
    Route::get('/admin/attribute/edit/{attribute_id}',AdminEditAtributeComponent::class)->name('admin.editattribute');

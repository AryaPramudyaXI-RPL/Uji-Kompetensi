        ...
        <div class=" main-content-area">
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                    ...
                                    <select class="" wire:model="country" style="width: 100%;height: 45px;">
            ...
            <div class="summary summary-checkout">
                ...
                <div class="summary-item shipping-method">
                    ...
                    <p class="row-in-form">
                                    <label class="col-md-4 control-label">Ekspedisi</label>
                                    <select class="" wire:model="kurir" wire:change="setShippingCharge" style="width: 100%;height: 45px;">
                                        <option value="0">Select Ekspedisi</option>
                                        @foreach ($ekspeditions as $ekspedition )
                                        <option value="{{$ekspedition->price_km}}">{{$ekspedition->kurir}}</option>
                                        @endforeach
                                    </select>
                            </p>

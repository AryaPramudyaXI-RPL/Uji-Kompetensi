									...
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												...
												<li class="menu-item"><a href="/user/orders" class="link-term">Order History</a></li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											...
											<li><a href="{{$setting->faceboo}}" class="link-to-item" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						...
						<div class="back-link-box">
							...
							<div class="back-link-row">
								<ul class="list-back-link" >
                                    ...
                                    <li><a href="{{route('product.category',['category_slug'=>$category->slug])}}" class="redirect-back-link" title="{{$category->name}}">{{$category->name}}</a></li>
                                    @endforeach
								</ul>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Yappier Albert. All rights reserved</p>
					</div>
